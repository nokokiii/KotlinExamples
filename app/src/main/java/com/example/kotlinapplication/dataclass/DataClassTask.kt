...
class ContactManager {
    ...
    fun updateContact(name: String, newPhoneNumber: String, newEmail: String) {
        val contact : Contact = findContactsByName(name)[0]
        contacts[contacts.indexOf(contact)] = contact.copy(email = newEmail, phoneNumber = newPhoneNumber)
    }
    ...
    fun alreadyAdded(contact: Contact) : Boolean {
