...
enum class UserRole(val authLevel : Int) {
    Admin(3) {
        override fun canPerformAction(action: String): Boolean = true;
    },
    User(2) {
        override fun canPerformAction(action: String): Boolean = action == "view data";
    },
    Guest(1) {
